...
public class Pokemon{
	...
	private float vida;
        ...
        private InputStream fotod;
        
        private InputStream fotof;
	...
	public void setVida(float vida) {
        ...
        public InputStream getFotod() {
            return fotod;
        }

        public void setFotod(InputStream fotod) {
            this.fotod = fotod;
        }

        public InputStream getFotof() {
            return fotof;
        }

        public void setFotof(InputStream fotof) {
            this.fotof = fotof;
        }
        
        public void insertar() throws SQLException, FileNotFoundException{
