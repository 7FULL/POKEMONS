...
public class BatallaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			Pokemon pokemon1 = PokemonDao.getInstance().recibirPokemonPorNombre(data.get("nombre1").getAsString());
			
			Pokemon pokemon2 = PokemonDao.getInstance().recibirPokemonPorNombre(data.get("nombre2").getAsString());
