...
<head>
    ...
    <body> 
        ...
        <script src="js/jsonpokemon.js"></script>
        <header class="header">
         <a href="index.jsp"><img class= "logo" src="img/International_Pokemon_logo.svg.png"></a>
         <div class="botones">
         <a href='multijugador.jsp'><button class='mi-boton'>Multijugador</button></a>
     ...
     <div class="azul" id="azul">
         ...
         <select name="seleccionpokemon" id="seleccion1">
         </select>
     <div class="cian" id="cian">
