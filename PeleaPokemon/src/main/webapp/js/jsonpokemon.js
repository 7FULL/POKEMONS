window.onload = function(){
    ...
    function accion(x){
        ...
        fetch('AtaqueSinglePlayerServlet', {
            method: "POST",
    ...
    fetch("RecibirImagenesFrontales",{
        method: "POST"
            ...
            .then(datos=>{
                ...
                let url2 = "img/pokemons/"+imagenesFrontales[0];
    ...
    y.addEventListener("change",function(){  
         let url2 = "img/pokemons/"+imagenesFrontales[y.selectedIndex];
    ...
    batalla.addEventListener("click", function(){
        ...
        pokemon1.src = "img/pokemons/"+imagenesEspalda[x.selectedIndex];
        
        pokemon2.src = "img/pokemons/"+imagenesFrontales[y.selectedIndex];
